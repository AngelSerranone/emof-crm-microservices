...
GRANT ALL PRIVILEGES ON contact.* TO 'adrialopezbou'@'localhost';
...
GRANT ALL PRIVILEGES ON sales_rep.* TO 'adrialopezbou'@'localhost';
...
GRANT ALL PRIVILEGES ON account.* TO 'adrialopezbou'@'localhost';
DROP SCHEMA account;
...
GRANT ALL PRIVILEGES ON lead_service.* TO 'adrialopezbou'@'localhost';
