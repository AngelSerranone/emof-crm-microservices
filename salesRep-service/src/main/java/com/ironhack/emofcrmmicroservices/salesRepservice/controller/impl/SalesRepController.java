...
import com.ironhack.emofcrmmicroservices.salesRepservice.controller.interfaces.ISalesRepController;
...
public class SalesRepController implements ISalesRepController {
    ...
    public List<LeadsBySalesRepDto> getLeadsBySalesRep() {
        return salesRepService.getLeadsBySalesRep();
    }

    @GetMapping("/report/opps-by-salesRep")
    public List<OppsBySalesRepDto> getOppsBySalesRep() {
        return salesRepService.getOppsBySalesRep();
    }
}
